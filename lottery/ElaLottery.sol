...
contract ElaLottery is AccessController{
    ...
    uint256 maxFirstPrize = 1500 ether;
    uint256 maxSecondPrize = 130 ether;
    uint256 maxThirdPrize = 9 ether;
